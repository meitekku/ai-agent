...
function hasValidChartData(chart?: SlideChart | null): boolean {
  ...
  return datasets.some(
    (ds) =>
      ...
      ds.data.length > 0 &&
      ds.data.some((v) => typeof v === "number" && v !== 0),
  );
}
...
export function SlideStudio({
  ...
  }, [open, selectedSlide?.id, selectedSlide?.chart, selectedIndex]);
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            updateSlide(selectedIndex, {
                              bullets: textareaToBullets(e.target.value),
                            })
                          }
          ...
          {exportIndex === 0 ? (
            ...
            <div className="h-full flex flex-col">
              ...
              {(slideForExport?.bullets || []).length > 4 && (
                <div
                  className="px-8 pb-4 text-sm text-right"
                  style={{ color: PREVIEW_COLORS.textMuted }}
                >
            ...
            <div className="h-full p-12 flex flex-col">
              ...
              <div className="flex items-center gap-4 mb-6">
                <div
                  ...
                  style={{
                    background: PREVIEW_COLORS.primaryLight,
                    border: `2px solid ${PREVIEW_COLORS.primaryMid}`,
                  }}
                >
                  {slideForExport?.chart?.type
                    ? "📊"
              ...
              <div className="flex-1 flex gap-8 min-h-0">
                ...
                {(exportDiagramSvg ||
                  ...
                  <div
                    ...
                    style={{
                      background: PREVIEW_COLORS.backgroundAlt,
                      border: `2px solid ${PREVIEW_COLORS.border}`,
                    }}
                  >
                    {exportDiagramSvg ? (
                      <div
              ...
              {(slideForExport?.bullets || []).length > 0 && (
                ...
                >
                  💡 <strong>Takeaway:</strong> {slideForExport?.title}
                  のポイントを整理し、次のアクションを明確化
                </div>
              )}
