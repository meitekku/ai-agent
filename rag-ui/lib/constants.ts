...
export const QUERY_SERVICE_URL = process.env.QUERY_SERVICE_URL || "http://localhost:8006";
...
export const MLX_MODEL = process.env.MLX_MODEL || "mlx-community/Qwen3.5-35B-A3B-4bit";
